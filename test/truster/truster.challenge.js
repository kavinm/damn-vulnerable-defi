...
describe("[Challenge] Truster", function () {
  ...
  it("Execution", async function () {
    let approveABI = ["function approve(address to, uint256 amount)"];
    let approve = new ethers.utils.Interface(approveABI);
    const data = approve.encodeFunctionData("approve", [
      player.address,
      TOKENS_IN_POOL,
    ]);

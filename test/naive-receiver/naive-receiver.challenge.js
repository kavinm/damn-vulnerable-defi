...
describe("[Challenge] Naive receiver", function () {
  ...
  before(async function () {
    ...
    const Receiver1TransactionFactory = await ethers.getContractFactory(
      "NaiveReceiver1Transaction",
      deployer
    );
    ...
    drainer = await Receiver1TransactionFactory.deploy(pool.address);
